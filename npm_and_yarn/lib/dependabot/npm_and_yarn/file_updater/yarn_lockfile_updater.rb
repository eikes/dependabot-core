      ...
      class YarnLockfileUpdater
        ...
        def write_temporary_dependency_files(yarn_lock, update_package_json: true)
          ...
          package_files.each do |file|
            ...
            updated_content = prepared_package_json_content(updated_content)
        ...
        def prepared_package_json_content(content)
          @prepared_package_json_content ||= {}
          @prepared_package_json_content[content] ||=
